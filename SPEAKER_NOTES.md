...
**How to read this:** Each slide has a `[#] Title · SPEAKER · ~time`. The text below it is the word-by-word script — read it as written, or use it as a spine and improvise. Handoffs between speakers are marked **▶ HANDOFF**. Lines in *(parentheses italics)* are stage directions, not spoken.

**Pacing:** This runs ~40 minutes at a brisk keynote pace. The deck is dense, so the "in action" code slides and the roadmap divider slides are meant to go *fast* — one or two breaths each. If you're running long, the first things to compress are the code walk-throughs and the divider slides. Rough section budget:

| Section | Slides | Budget |
|---|---|---|
| Open (title, overview, agenda, map) | 1–5 | 4:00 |
| 01 · Metrics & Semantic Modeling | 6–9 | 3:30 |
| 02 · Spark Connect | 10–13 | 2:15 |
| 03 · PySpark | 14–30 | 6:00 |
| 04 · Spark SQL | 31–51 | 6:30 |
| 05 · Pipelines & Auto CDC | 52–55 | 2:30 |
| 06 · Structured Streaming | 56–60 | 2:15 |
| 07 · Data Source V2 | 61–75 | 5:00 |
| 08 · Performance, UI & Ops | 76–79 | 2:00 |
| 09 · Looking Ahead | 80–97 | 5:00 |
| Recap & close | 98–99 | 1:00 |
| **Total** | | **~40:00** |

---

## OPEN — Slides 1–5 · ~4:00
...
*(XIAO:)* Between the two of us we've spent a lot of years living inside the Spark codebase — and today we get to do one of our favorite things: show you what's coming in **Apache Spark 4.2**. The theme this year is right there on the slide — **native analytics for data and AI**. You'll see that thread run through everything we show you. Let's dig in.
...
## 01 · METRICS & SEMANTIC MODELING — Slides 6–9 · ~3:30
...
*(Walk the example briefly.)* Here you define the view once — the dimensions, the measures. And then look at the queries: same metric, sliced by region, by month, rolled up to a total — and the numbers are *consistent at every grain*, because the engine knows how to aggregate each measure. You write the definition once; everyone downstream just asks questions.
**▶ HANDOFF to DB.** And with the foundation set, let me hand to DB to talk about how you actually connect to Spark.

---

## 02 · SPARK CONNECT — Slides 10–13 · ~2:15

### [10] Section divider — Spark Connect · **DB** · ~0:15
Thanks, Xiao. So — how does your application *talk* to Spark? Increasingly, the answer is Spark Connect.

### [11] Architecture: gRPC in, Arrow out · **DB** · ~0:50
...
## 03 · PYSPARK — Slides 14–30 · ~6:00

### [14] Section divider — PySpark, Faster by Default · **DB** · ~0:12
Now to the language most of you actually write Spark in: Python. And the headline here is in the title — **faster by default**.

### [15] Roadmap (Arrow by default) · **DB** · ~0:08
*(One breath. Point at item 1.)* Four things in the PySpark story. First — Arrow, on by default.

### [16] Arrow on by default · **DB** · ~0:45
...
### [17] Python UDFs: same code, now faster · **DB** · ~0:30
...
### [20] Arrow UDFs in action · **DB** · ~0:30
...
### [21] Roadmap (Interop & debugging) · **DB** · ~0:06
*(One breath.)* Third — interoperability and the developer experience.

### [22] Better interop & developer experience · **DB** · ~0:45
...
### [23] PyCapsule interop in action · **DB** · ~0:30
...
### [24] Debug UDFs where they run · **DB** · ~0:45
...
### [25] UDF debugging in action · **DB** · ~0:25
...
### [26] Roadmap (Python Data Sources) · **DB** · ~0:06
*(One breath.)* And fourth — my favorite — Python Data Sources.

### [27] Python Data Sources: connectors in pure Python · **DB** · ~0:55
...
### [28] A growing Python Data Source ecosystem · **DB** · ~0:30
...
### [29] Python Data Sources in action · **DB** · ~0:25
...
### [30] Profiling Python Data Sources · **DB** · ~0:35
...
**▶ HANDOFF to XIAO.** With Python humming, let me hand back to Xiao for the biggest section: Spark SQL.

---

## 04 · SPARK SQL — Slides 31–51 · ~6:30

### [31] Section divider — Spark SQL · **XIAO** · ~0:15
Thanks, DB. Spark SQL is where the largest number of new features landed this release — so we've split it into four themes.
...
**▶ HANDOFF stays XIAO** *(Pipelines is also Xiao — no handoff needed.)*

---

## 05 · PIPELINES & AUTO CDC — Slides 52–55 · ~2:30

### [52] Section divider — Declarative Pipelines & Auto CDC · **XIAO** · ~0:12
Let's talk about one of the most painful things in data engineering — keeping a table in sync with a stream of changes.

### [53] Applying a change feed is the hard part · **XIAO** · ~0:50
...
### [54] Auto CDC: declare it, Spark reconciles it · **XIAO** · ~0:55
...
### [55] Auto CDC in action · **XIAO** · ~0:30
*(Code slide.)* Here's the whole thing — declare the flow, point it at the change feed, name your keys and sequence column. Those few lines replace the hundreds we just talked about.
**▶ HANDOFF to DB.** DB, take us into streaming.

---

## 06 · STRUCTURED STREAMING — Slides 56–60 · ~2:15

### [56] Section divider — Structured Streaming · **DB** · ~0:12
Thanks. Streaming in 4.2 is about two things: evolving running queries safely, and a state store you can actually trust.
...
**▶ HANDOFF to XIAO.** Xiao, the data-source story.

---

## 07 · DATA SOURCE V2 — Slides 61–75 · ~5:00

### [61] Section divider — Data Source V2 · **XIAO** · ~0:15
Thanks, DB. Data Source V2 is the plumbing that connects Spark to the world's data — and it grew up a lot this release.

### [62] One integration API for every data source · **XIAO** · ~0:40
...
### [63] Roadmap (Reading changes) · **XIAO** · ~0:06
*(Point at item 1.)* Three themes. First — reading changes.

### [64] Ask the table: "what changed?" · **XIAO** · ~0:45
...
### [65] Two problems with CDC today · **XIAO** · ~0:50
...
### [66] One CHANGES API for any DSv2 source · **XIAO** · ~0:45
...
### [67] Reading changes in action · **XIAO** · ~0:25
...
### [68] Delta goes read-time — by default · **XIAO** · ~0:50
...
### [69] Roadmap (Smarter writes) · **XIAO** · ~0:06
*(One breath.)* Second theme — smarter writes.

### [70] Smarter writes: INSERT & MERGE · **XIAO** · ~0:40
...
### [73] Observable, evolvable DML · **XIAO** · ~0:35
...
### [74] Roadmap (Smarter pushdown) · **XIAO** · ~0:06
*(One breath.)* And the third theme — smarter pushdown.

### [75] Smarter pushdown: PartitionPredicate · **XIAO** · ~0:35
...
**▶ HANDOFF to DB.** DB, bring us home on performance and operations.

---

## 08 · PERFORMANCE, UI & OPERATIONS — Slides 76–79 · ~2:00

### [76] Section divider — Performance, UI & Operations · **DB** · ~0:12
Thanks, Xiao. Last of the shipped features — the things that make Spark faster, easier to see into, and easier to run.
...
Earlier I mentioned real-time mode. SPARK-54699 **extends it to stateful queries** — targeting roughly **100-millisecond** end-to-end latency. It builds on real-time mode for **stateless** queries, which shipped in **4.1** — now bringing that same low latency to `transformWithState` and aggregations. Two pieces make it work: a **streaming shuffle** — a push-based exchange that streams task output straight downstream, instead of waiting on batch boundaries — and **concurrent stage scheduling**, so multiple plan stages run at once and stateful operators keep pace. Real-time stateful streaming, at Spark scale.
**▶ HANDOFF to XIAO.** And to close the roadmap — Xiao, on how we'll actually ship all of this.

### [95] Roadmap (Faster releases) · **XIAO** · ~0:05
*(One breath.)* And the last one is about *cadence.*

### [96] Faster, predictable releases · **XIAO** · ~0:50
...
### [97] An example release calendar · **XIAO** · ~0:35
...
## CLOSE — Slides 98–99 · ~1:00

### [98] Now Available: Apache Spark™ 4.2 · **XIAO** · ~0:40
...
### [99] Join the community today! · **XIAO + DB** · ~0:20
*(XIAO:)* All of this is the work of the Apache Spark community — and that community is open to you. *(DB:)* Grab the release at spark.apache.org, the source on GitHub, and join the dev and user lists — we'd love your contributions, and your bug reports. *(Both:)* Thank you, DAIS — enjoy the rest of the Summit!
